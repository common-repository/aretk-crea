...
jQuery(document).ready(function () {
    ...
    function ws_getTileOptions(width, layout, footerType, showCommute) {
    ...
    function ws_getDefaultTileHeight(width, layout, footerType, showCommute) {
        ...
        if (hideFooter) {
            ...
            if (input) {
                ...
                input.onfocus = function () {
                    if (this.value == 'Enter an address') this.value = '';
                }
            }
