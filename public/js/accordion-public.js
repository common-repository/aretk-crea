...
//script for crea setting form 
    ...
    /*jQuery( "#feature_accordion" ).accordion({ collapsible: true, active: false, icons: icons, autoHeight:false  });
     jQuery( "#detail_accordion" ).accordion({ collapsible: true, active: false, icons: icons, autoHeight:false  });
     jQuery( "#address_accordion" ).accordion({ collapsible: true, active: false, icons: icons, autoHeight:false  });
     jQuery( "#walkscore_accordion" ).accordion({ collapsible: true, active: false, icons: icons, autoHeight:false  }); */
